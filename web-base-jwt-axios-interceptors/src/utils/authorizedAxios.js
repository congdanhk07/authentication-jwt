...
//withCredentials: Cho phép đính kèm và gửi cookie trong mỗi request lên BE khi chúng ta dùng JWT tokens (access and refresh) theo http Only
...
authorizedAxiosInstance.interceptors.response.use(
  (response) => {
    // Mọi http status code nằm trong khoảng 2xx thì sẽ là error và xử lỷ ở đây
    // Do something with response data
    return response
  },
  (error) => {
    // Mọi http status code nằm ngoài khoảng 2xx thì sẽ là error và xử lỷ ở đây
